...
namespace TGC.Group.Model.Camara
{
    ...
    /// </summary>
    public class TgcFpsCameraCraft : TgcCamera
    {
        /// <summary>
        ...
        public TgcFpsCameraCraft(TGCVector3 pos, TGCVector3 lookAt)
        {
            this.positionEye = pos;
            this.directionView = lookAt;
            ...
            public TgcFpsCameraCraft(TgcD3dInput input)
        {
            this.Input = input;
        ...
        /// <param name="input"></param>
        public TgcFpsCameraCraft(TGCVector3 positionEye, TgcD3dInput input) : this(input)
        {
        ...
        /// <param name="input"></param>
        public TgcFpsCameraCraft(TGCVector3 positionEye, float moveSpeed, float jumpSpeed, TgcD3dInput input)
        ...
        /// <param name="input"></param>
        public TgcFpsCameraCraft(TGCVector3 positionEye, float moveSpeed, float jumpSpeed, float rotationSpeed, TgcD3dInput input)
