...
namespace TGC.Group.Model.Camara
{
    ...
    /// </summary>
    public class TgcFpsCameraMenu : TgcCamera
    {
        /// <summary>
        ...
        public TgcFpsCameraMenu(TGCVector3 pos, TGCVector3 lookAt)
        {
            ...
            public TgcFpsCameraMenu(TgcD3dInput input)
        {
            this.Input = input;
        ...
        /// <param name="input"></param>
        public TgcFpsCameraMenu(TGCVector3 positionEye, TgcD3dInput input) : this(input)
        {
        ...
        /// <param name="input"></param>
        public TgcFpsCameraMenu(TGCVector3 positionEye, float moveSpeed, float jumpSpeed, TgcD3dInput input)
        ...
        /// <param name="input"></param>
        public TgcFpsCameraMenu(TGCVector3 positionEye, float moveSpeed, float jumpSpeed, float rotationSpeed, TgcD3dInput input)
